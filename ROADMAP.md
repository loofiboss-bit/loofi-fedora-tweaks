...
The v30.1.0 source is the release authority. Physical GNOME, KDE, Polkit,
Atomic, keyboard, Orca, and scaling checks remain unverified. See the [architecture](.workflow/specs/arch-v30.1.0.md),
[tasks](.workflow/specs/tasks-v30.1.0.md), and
[release notes](docs/releases/RELEASE-NOTES-v30.1.0.md).
