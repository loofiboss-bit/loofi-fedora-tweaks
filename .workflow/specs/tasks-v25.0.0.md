# Tasks — v25.0.0 “Proof” (Superseded Candidate)

Status: superseded by the published v25.0.4 “Proof” release. This planning
snapshot is retained for lineage; it does not define the current release.
No task below authorizes host mutation.

## Phase 0 — baseline and lineage

- [x] T0.1 Record clean v24 checkout, rootless baseline tests, current public evidence, and exact v25 tag collisions.
- [x] T0.2 Establish Proof plan, architecture contract, and active race lock.
...
## Phase 5 — release candidate documentation and qualification

- [x] T5.1 Update active README, ROADMAP, ARCHITECTURE, CHANGELOG, user docs, completion, and man surfaces.
- [x] T5.2 Add candidate release notes, direct-action audit, and release qualification reports.
- [x] T5.3 Run full rootless gates; label public/physical/manual gates `blocked` or `unverified`.
