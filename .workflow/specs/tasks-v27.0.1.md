...
**Status:** release-ready; automated qualification complete.
...
- [x] Phase 6 — Automated qualification; run the full test suite plus lint,
  ...
  stabilization gates. Maintained-surface coverage is 86.95% against the 85%
  blocking gate.
...
- [ ] [post-publish] Raise coverage to repository-wide 90% and complete
  physical/manual Fedora qualification in a subsequent release.
