...
_ROUTES: tuple[NavigationRoute, ...] = (
    ...
    _route("maintenance:upgrade-assistant", "Upgrade Assistant", "maintenance", "Packages", "update", "Guided Fedora release planning, readiness checks, action review, and support export.", aliases=("Upgrade Assistant", "Release Upgrade", "Waypoint"), keywords=("upgrade", "release", "readiness", "fedora45", "waypoint"), risk="medium", subroute="upgrade-assistant"),
