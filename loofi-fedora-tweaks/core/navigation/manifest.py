...
_ROUTES: tuple[NavigationRoute, ...] = (
    ...
    _route(
        ...
        "System",
        "overview-dashboard",
        "Compatibility route to the maintained System overview.",
    ...
    _route("monitor", "Performance & Processes", "monitor", "System", "overview-dashboard", "Slow-system guidance, performance graphs, and process management.", aliases=("System Monitor", "Performance Monitor"), keywords=("cpu", "memory", "process", "traffic", "slow system"), visibility="beginner"),
    ...
    _route("maintenance:smart-updates", "Advanced Update Options", "maintenance", "Packages", "update", "Compatibility route to scheduling, conflict preview, and rollback options inside Updates.", aliases=("Smart Updates",), keywords=("smart", "updates", "plan", "schedule", "rollback"), risk="medium", subroute="smart-updates"),
    _route("maintenance:health-timeline", "Health Timeline", "maintenance", "Packages", "maintenance-health", "My Fedora Today snapshots, recurring issues, and trend-aware recommendations.", aliases=("Health Timeline", "My Fedora Today", "Lighthouse"), keywords=("health", "timeline", "snapshot", "recurring", "lighthouse"), subroute="health-timeline"),
    ...
    _route("maintenance:action-center", "Action Center", "maintenance", "Packages", "maintenance-health", "Preview, queue, confirm, verify, and review recent maintenance actions.", aliases=("Action Center", "Action Inbox", "Harbor Actions"), keywords=("action", "preview", "queue", "rollback", "maintenance", "harbor"), risk="medium", subroute="action-center"),
    ...
    _route("snapshots", "Recovery Points", "snapshots", "Packages", "logs", "Create, list, and restore system recovery points.", aliases=("Snapshots", "Create Snapshot", "Recovery Points"), keywords=("snapshot", "timeshift", "snapper", "btrfs", "rollback"), risk="medium", visibility="advanced"),
    ...
    _route("backup", "Backups", "backup", "Security", "storage-disk", "Guided system backup protection and restore workflows.", aliases=("Backup", "System Backup"), keywords=("backup", "restore", "protection"), risk="medium", visibility="beginner"),
    ...
    _route("settings:advanced", "Advanced Tools", "settings", "Appearance", "settings", "Navigation mode and advanced application preferences.", aliases=("Advanced",), keywords=("advanced", "developer", "mode"), subroute="advanced"),
    _route("settings:repair", "Repair Loofi", "settings", "Appearance", "maintenance-health", "Inspect, back up, and preview restore of Loofi application state.", aliases=("State Doctor", "State & Recovery", "Repair Loofi"), keywords=("state", "doctor", "repair", "backup", "restore"), subroute="repair"),
    _route("settings:about", "About", "settings", "Appearance", "info", "Version, build, runtime, and Fedora support information.", aliases=("About Loofi",), keywords=("version", "build", "support", "runtime"), subroute="about"),
    ...
    _route("health", "System Health", "health", "Maintenance", "maintenance-health", "Compatibility route to consolidated troubleshooting and health signals.", aliases=("Health",), keywords=("health", "timeline", "history"), visibility="beginner"),
    _route("logs", "System Logs", "logs", "Maintenance", "logs", "Compatibility route to journal and error review in Troubleshooting.", aliases=("Logs", "Smart Logs"), keywords=("journal", "logs", "errors"), visibility="advanced"),
    _route("diagnostics", "Troubleshooting", "diagnostics", "Maintenance", "maintenance-health", "Health, failed services, journal review, and boot diagnostics.", aliases=("Diagnostics", "Watchtower", "Health", "Logs"), keywords=("diagnostics", "boot", "watchtower", "journal", "services"), visibility="beginner"),
    _route("diagnostics:watchtower", "Health & Troubleshooting", "diagnostics", "Maintenance", "maintenance-health", "System health, service, journal, and support evidence.", aliases=("Watchtower", "System Health"), keywords=("diagnostic", "doctor", "health", "logs"), subroute="watchtower"),
