"""Support Bundle v3 for Fedora KDE 44 readiness diagnostics."""
...
class SupportBundleV3:
    """Privacy-masked Fedora KDE 44 diagnostic bundle."""

    BUNDLE_SCHEMA = "5.0.0-aurora-support-v3"
    ...
    @classmethod
    def generate_bundle(cls) -> Dict[str, Any]:
        readiness = Fedora44Readiness.run()
        ...
        bundle = {
            ...
            "timestamp": time.time(),
            "system": system_info,
            "fedora_kde_44_readiness": readiness.to_dict(advanced=True),
    ...
    @classmethod
    def save_json(cls, path: str) -> str:
        bundle = cls.generate_bundle()
