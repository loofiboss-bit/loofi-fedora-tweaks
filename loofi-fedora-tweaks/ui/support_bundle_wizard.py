...
class SupportBundleWizard(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.bundle_gen = SupportBundleV2(self.registry)
        self.bundle_data = {}
    ...
    def _gather_data(self):
        """Collect data from SupportBundleV2 and update preview."""
        try:
            ...
            logger.error(f"Failed to generate support bundle: {e}", exc_info=True)
