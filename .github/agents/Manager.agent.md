...
description: Project management and task coordination agent for Loofi Fedora Tweaks v2.2.1. Breaks down complex features into implementable tasks and coordinates multi-step implementations.
argument-hint: A complex task or feature request that needs to be broken down (e.g., "Implement cloud backup feature" or "Coordinate v2.2.1 release")
...
- **Version**: v2.2.1 "Evolution" | **Python**: 3.12+ | **Framework**: PyQt6
