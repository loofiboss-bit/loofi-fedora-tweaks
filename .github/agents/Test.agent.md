...
description: Testing specialist for Loofi Fedora Tweaks v2.2.1. Creates comprehensive unit tests following project conventions with proper mocking of system calls.
