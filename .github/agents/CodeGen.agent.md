...
description: General-purpose code implementation agent for Loofi Fedora Tweaks v2.3.0. Implements features, fixes bugs, and makes code changes following project architecture.
