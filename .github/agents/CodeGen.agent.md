...
description: General-purpose code implementation agent for Loofi Fedora Tweaks v3.0.1 Aegis. Implements features, fixes bugs, and makes code changes following project architecture.
