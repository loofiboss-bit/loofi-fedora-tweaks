# Historical Release Notes v23.0.0 "Architecture Hardening"

> Historical pre-normalization documentation for the existing `v23.0.0` tag.
> This file is not release evidence or release notes for the active Compass
