...
This map covers the public v28.0.2 "Ease" release. Exact tag, asset,
attestation, COPR, and wiki evidence are recorded in the
[v28.0.2 public release report](reports/V28.0.2_RELEASE_PUBLICATION.md). The
previous public release report remains in
[V28_RELEASE_PUBLICATION.md](reports/V28_RELEASE_PUBLICATION.md).
...
- [Release readiness](FEDORA_KDE_44_READINESS.md) — capability-aware Fedora
  readiness and qualification boundaries
- [Administration](ADVANCED_ADMIN_GUIDE.md) — operator runbooks and release
  verification
...
- [v28.0.2 Ease release notes](releases/RELEASE-NOTES-v28.0.2.md) — current public release scope
- [v28.0.2 public release evidence](reports/V28.0.2_RELEASE_PUBLICATION.md) — exact publication readback
- [v28.0.1 public release evidence](reports/V28_RELEASE_PUBLICATION.md) — previous exact publication readback
...
Historical plans, reports, release notes, archives, and screenshots remain
available under their respective directories. They describe the release named
in each file and are not current usage instructions.
