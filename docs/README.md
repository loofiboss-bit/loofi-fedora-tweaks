...
This map covers the v28.0.2 "Ease" release candidate. Exact tag, asset,
attestation, COPR, and wiki evidence will be recorded after the canonical
publication workflow completes. The previous public release report remains in
...
- [v28.0.2 Ease release notes](releases/RELEASE-NOTES-v28.0.2.md) — current release candidate scope
