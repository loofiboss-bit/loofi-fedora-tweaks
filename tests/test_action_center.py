...
class TestActionCenterService(unittest.TestCase):
    ...
    def test_legacy_queue_has_no_execution_api(self):
        facade = MagicMock()
        ...
        self.assertFalse(hasattr(service, "execute_next"))
        self.assertIsNone(service.queue.next_ready())
        self.assertEqual(service.queue.pending(), [item])
